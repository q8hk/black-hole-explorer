...
export class RelativisticRenderer {
  ...
  constructor(private canvas: HTMLCanvasElement){
    ...
    this.locations={}; for(const name of ['u_resolution','u_camera','u_tetrad[0]','u_look','u_maxSteps','u_cutoff','u_debug']){const loc=gl.getUniformLocation(program,name);if(loc)this.locations[name]=loc;}
  }
